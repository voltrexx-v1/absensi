...
class _SettingsViewState extends State<SettingsView> {
  String _activeSetting =
      'menu'; // 'menu', 'shift', 'departemen', 'devices', 'profile'
  ...
  Future<Map<String, dynamic>?> _loadConfig() async {
    ...
    var data = await ApiService.getConfig(
        'site?t=${DateTime.now().millisecondsSinceEpoch}');
            ...
            child: Column(
              ...
              children: [
                ...
                _buildMenuItem(
                    ...
                    subtitle: "Pusat bantuan dan kontak CS",
                    onTap: () => widget.onChangeView('help')),
                _buildMenuItem(
                  icon: Icons.logout,
                  title: "Keluar",
          ...
          Row(
            children: [
              IconButton(
                  ...
                  icon:
                      const Icon(Icons.arrow_back, color: AppColors.slate800)),
            ...
            child: Column(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  subtitle: const Text(
                      "Mainkan suara saat ada notifikasi pesan atau aktivitas baru",
                      style:
                          TextStyle(color: AppColors.slate500, fontSize: 12)),
                ...
                const Text("Pilihan Nada Dering",
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color: AppColors.slate700)),
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                _buildRowInput(
                                    "Password Lama", (v) => currentPass = v),
                                _buildRowInput(
                                    "Password Baru", (v) => newPass = v),
                                _buildRowInput("Konfirmasi Password",
                                    (v) => confirmPass = v),
                                const SizedBox(height: 8),
                                const Text(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                        ...
                                        shape: RoundedRectangleBorder(
                                            borderRadius:
                                                BorderRadius.circular(12))),
                                    onPressed:
                                        isSubmitting ? null : submitPassword,
                                    child: isSubmitting
                                        ? const SizedBox(
                                            width: 16,
                                            height: 16,
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      color:
                          isDestructive ? AppColors.rose50 : AppColors.slate50,
                      borderRadius: BorderRadius.circular(12)),
                  child: Icon(icon,
                      color: isDestructive
                          ? AppColors.rose500
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildMenuCard(
              title: "Radar & Lokasi Site",
              subtitle:
                  "Konfigurasi titik pusat GPS, radius absensi, dan area.",
          ...
          const SizedBox(height: 16),
          _buildMenuCard(
              title: "Pengaturan Shift (Waktu)",
              subtitle:
                  "Kelola aturan jam masuk dan jam pulang untuk setiap site.",
              icon: Icons.timer,
              onTap: () => setState(() => _activeSetting = 'shift')),
          const SizedBox(height: 16),
          _buildMenuCard(
              title: "Departemen & Jabatan",
              subtitle: "Kelola daftar divisi dan posisi untuk data karyawan.",
              icon: Icons.work,
              onTap: () => setState(() => _activeSetting = 'departemen')),
          const SizedBox(height: 16),
          _buildMenuCard(
              title: "Kelola Perangkat",
              subtitle: "Reset pengikatan perangkat (Device Lock) karyawan.",
              icon: Icons.devices,
              onTap: () => setState(() => _activeSetting = 'devices')),
          const SizedBox(height: 16),
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasData) {
                  ...
                  if (widget.user.role == 'Head Area') {
                    docs = docs
                        .where((d) => d['area'] == widget.user.area)
                        .toList();
                  }
                ...
                return _buildMenuCard(
                    ...
                    onTap: () {
                      widget.onChangeView('admin_tickets');
                    });
              }),
          ...
          _buildMenuCard(
              title: "Ganti Password",
              subtitle: "Perbarui kata sandi akun Admin",
              icon: Icons.lock_outline,
              onTap: () => _showChangePasswordDialog()),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                            "Akhiri sesi Anda dan keluar dari sistem secara aman.",
                            style: TextStyle(
                                fontSize: isMobile ? 10 : 11,
                                color: AppColors.slate500,
                                fontWeight: FontWeight.bold))
                  ...
                  if (!isMobile)
                    const Icon(Icons.close, color: AppColors.rose400, size: 20),
                ],
              ),
            ),
          ),
          ...
          children: [
            Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(20)),
                child: Icon(icon,
                    color: AppColors.slate800, size: isMobile ? 24 : 28)),
    ...
    return FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (context, userSnap) {
          ...
          userData['nama_lengkap'] =
              userData['nama_lengkap'] ?? widget.user.namaLengkap;
                ...
                children: [
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          color: Colors.white,
                          borderRadius:
                              BorderRadius.circular(isMobile ? 24 : 40),
                          border: Border.all(color: AppColors.slate200),
                          boxShadow: const [
                            BoxShadow(color: AppColors.black12, blurRadius: 10)
                          ]),
                      child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            isMobile
                                ? Column(
                                    ...
                                    children: [
                                        const Text("DAFTAR PERANGKAT KARYAWAN",
                                            style: TextStyle(
                                                fontSize: 12,
                                                fontWeight: FontWeight.w900,
                                                color: AppColors.slate500,
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  if (users.isEmpty) {
                                    return const Padding(
                                      ...
                                      child: Center(
                                        child: Text(
                                            "Tidak ada data karyawan di area yang dipilih.",
                                            style: TextStyle(
                                                color: AppColors.slate400,
                                                fontWeight: FontWeight.bold)),
                                      ),
                                  ...
                                  return ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        String area =
                                            userData['area'] ?? 'Belum Diatur';

                                        String mobileId =
                                            userData['mobileDeviceId'] ?? '';
                                        String desktopId =
                                            userData['desktopDeviceId'] ?? '';
                                        if (userData['device'] != null) {
                                          mobileId = userData['device']
                                                  ['mobileDeviceId'] ??
                                              mobileId;
                                          desktopId = userData['device']
                                                  ['desktopDeviceId'] ??
                                              desktopId;
                                        }
                                        ...
                                        if (mobileId.isEmpty &&
                                            desktopId.isEmpty &&
                                            userData.containsKey('device_id') &&
                                        ...
                                        return Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 4),
                                            Text(
                                                "$nik | Site Area: ${area.toUpperCase()}",
                                                style: const TextStyle(
                                                    fontSize: 11,
                                                    color: AppColors.slate500,
                                                    fontWeight: FontWeight.bold,
  ...
  Widget _buildAreaDropdown(List<String> availableAreas, bool isMobile) {
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          isExpanded: true,
          value: availableAreas.contains(_deviceFilterArea)
              ? _deviceFilterArea
              : 'Semua Area',
          ...
          onChanged: (String? newValue) =>
              setState(() => _deviceFilterArea = newValue!),
  ...
  Widget _buildDeviceCard(
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: isBound ? AppColors.slate200 : AppColors.slate100),
            borderRadius: BorderRadius.circular(16)),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Row(children: [
              Icon(
                  title.contains("Handphone")
                      ? Icons.smartphone
                      : Icons.computer,
                  size: 16,
                  color: AppColors.slate500),
            ...
            Icon(isBound ? Icons.lock : Icons.lock_open,
                size: 16,
                color: isBound ? AppColors.rose500 : AppColors.emerald500),
          ]),
          const SizedBox(height: 12),
          Text(
              isBound
                  ? "Terikat (ID: ${deviceId.length > 8 ? deviceId.substring(0, 8) : deviceId}...)"
                  : "Belum Terikat",
              style: TextStyle(
                  fontSize: 10,
                  fontWeight: FontWeight.w900,
                  color: isBound ? AppColors.rose600 : AppColors.emerald600)),
          const SizedBox(height: 16),
          SizedBox(
              width: double.infinity,
              child: ElevatedButton.icon(
                style: ElevatedButton.styleFrom(
                    backgroundColor:
                        isBound ? AppColors.slate900 : AppColors.slate100,
                    foregroundColor:
                        isBound ? Colors.white : AppColors.slate400,
                    elevation: 0,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12)),
  ...
  void _resetDevice(String docId, String userName, String fieldName,
    ...
    bool confirm = await showDialog(
        ...
        builder: (c) => AlertDialog(
                ...
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(24)),
                title: Text("Reset $deviceType?",
                    style: const TextStyle(fontWeight: FontWeight.w900)),
                content: Text(
                    "Aksi ini akan menghapus pengikatan $deviceType dan mengizinkan '$userName' untuk login di perangkat $deviceType baru. Lanjutkan?",
      ...
      try {
        ...
        if (mounted)
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text("Perangkat $deviceType berhasil di-reset!"),
              backgroundColor: AppColors.emerald500));
        setState(() {}); // Refresh UI
      } catch (e) {
        if (mounted)
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text("Gagal reset perangkat."),
              backgroundColor: AppColors.rose500));
      }
    }
  }
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError)
          return Center(
              child: Padding(
                  padding: EdgeInsets.all(padding),
                  child: const Text("Terjadi kesalahan memuat data konfigurasi",
        ...
        List<Map<String, dynamic>> shifts =
            shiftsData.map((e) => Map<String, dynamic>.from(e)).toList();

        List<Map<String, dynamic>> filteredShifts = shifts.where((s) {
          if (_selectedShiftArea == 'Semua Area')
            return true; // Show all shifts
          String sArea = s['area'] ?? 'Semua Area';
          return sArea == _selectedShiftArea || sArea == 'Semua Area';
        }).toList();

        var pagiShifts = filteredShifts
            .where((s) => !s['name'].toString().toLowerCase().contains('malam'))
            .toList();
        var malamShifts = filteredShifts
            .where((s) => s['name'].toString().toLowerCase().contains('malam'))
            .toList();
                  ...
                  children: [
                    ...
                    if (pagiShifts.isEmpty && malamShifts.isEmpty)
                      Padding(
                        ...
                        child: Center(
                            child: Text(
                                "Belum ada shift terdaftar di ${_selectedShiftArea.toUpperCase()}.",
                                style: const TextStyle(
                                    color: AppColors.slate400,
                                    fontWeight: FontWeight.bold))),
                      )
                      ...
                      if (pagiShifts.isNotEmpty) ...[
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context, index) => _buildShiftCard(
                              pagiShifts[index], shifts, availableAreas),
                        ),
                      ],
                      if (malamShifts.isNotEmpty) ...[
                        ...
                        ListView.separated(
                          ...
                          separatorBuilder: (_, __) => const Divider(
                              height: 1, color: AppColors.slate100),
                          itemBuilder: (context, index) => _buildShiftCard(
                              malamShifts[index], shifts, availableAreas),
                        ),
                      ]
                    ]
                  ],
  ...
  Widget _buildShiftCard(Map<String, dynamic> s,
      List<Map<String, dynamic>> allShifts, List<String> availableAreas) {
    return Padding(
                  ...
                  children: [
                    ...
                    if (s['area'] != null &&
                      ...
                      Container(
                        ...
                        child: Text(s['area'].toString().toUpperCase(),
                            style: const TextStyle(
          ...
          Row(
            ...
            children: [
              IconButton(
                  ...
                  tooltip: "Edit Shift",
                  onPressed: () =>
                      _showShiftDialog(s, allShifts, availableAreas)),
              IconButton(
                icon: const Icon(Icons.delete,
                    size: 20, color: AppColors.rose400),
                tooltip: "Hapus Shift",
                onPressed: () async {
                  bool confirm = await showDialog(
                    context: context,
                    builder: (c) => AlertDialog(
                      ...
                      content:
                          Text("Yakin ingin menghapus shift ${s['name']}?"),
                      actions: [
                        TextButton(
                            onPressed: () => Navigator.pop(c, false),
                            child: const Text("Batal")),
                  ...
                  if (confirm) {
                    List<Map<String, dynamic>> updated = List.from(allShifts)
                      ..removeWhere((item) => item['id'] == s['id']);
                    var currentData = Map<String, dynamic>.from(
                        await ApiService.getConfig('site') ?? {});
                    currentData['shifts'] = updated;
                    bool success =
                        await ApiService.updateConfig('site', currentData);
                    if (mounted) {
                      if (success) {
  ...
  void _showShiftDialog(Map<String, dynamic>? shiftToEdit,
      List<Map<String, dynamic>> currentShifts, List<String> availableAreas) {
        ...
        return StatefulBuilder(
          builder: (dialogContext, setDialogState) {
            ...
            void submitShift() async {
              ...
              List<Map<String, dynamic>> updatedShifts =
                  List.from(currentShifts);
              if (shiftToEdit == null) {
                bool exists = updatedShifts
                    .any((e) => e['name'] == name && e['area'] == shiftArea);
                if (exists) {
                  if (mounted)
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text("Shift $name sudah ada di area ini!"),
                        backgroundColor: AppColors.rose500));
                ...
                int idx = updatedShifts
                    .indexWhere((e) => e['id'] == shiftToEdit['id']);
                if (idx != -1) {
                  updatedShifts[idx] = {
                    'id': shiftToEdit['id'],
                    'name': name,
              ...
              if (success && mounted) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text("Shift berhasil disimpan!"),
                    backgroundColor: AppColors.emerald500));
                setState(() => _configRefreshKey++);
              } else if (mounted) {
                setDialogState(() => isSubmittingShift = false);
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text("Gagal menyimpan shift. Coba lagi."),
                    backgroundColor: AppColors.rose500));
              }
            }
            ...
            return AlertDialog(
              ...
              title: Row(
                children: [
                  ...
                  Expanded(
                      child: Text(
                          shiftToEdit == null ? "TAMBAH SHIFT" : "EDIT SHIFT",
                          style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      initialValue:
                          ['Pagi', 'Malam', 'Siang', 'General'].contains(name)
                              ? name
                              : 'Pagi',
                      decoration: InputDecoration(
                          filled: true,
                      ...
                      items: ['Pagi', 'Malam', 'Siang', 'General']
                    ...
                    DropdownButtonFormField<String>(
                      isExpanded: true,
                      initialValue: availableAreas.contains(shiftArea)
                          ? shiftArea
                        ...
                        onTap: () async {
                          TimeOfDay? picked = await showTimePicker(
                              ...
                              initialTime: TimeOfDay(
                                  hour: int.tryParse(start.split(':')[0]) ?? 8,
                                  minute:
                                      int.tryParse(start.split(':')[1]) ?? 0));
                          if (picked != null)
                      ...
                      InkWell(
                        onTap: () async {
                          TimeOfDay? picked = await showTimePicker(
                              context: context,
                              initialTime: TimeOfDay(
                                  hour: int.tryParse(end.split(':')[0]) ?? 17,
                                  minute:
                                      int.tryParse(end.split(':')[1]) ?? 0));
                          if (picked != null)
                            setDialogState(() => end =
                                "${picked.hour.toString().padLeft(2, '0')}:${picked.minute.toString().padLeft(2, '0')}");
                        },
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError)
          return Center(
              child: Padding(
                  padding: EdgeInsets.all(padding),
                  child: const Text("Terjadi kesalahan memuat data",
        ...
        if (data.containsKey('struktur_organisasi')) {
          strukturOrganisasi = List<Map<String, dynamic>>.from(
              (data['struktur_organisasi'] as List)
          ...
          strukturOrganisasi = [
            {
              'departemen': oldDeps.isNotEmpty ? oldDeps.first : 'Umum',
              'jabatan': oldJabs.isNotEmpty ? oldJabs.first : 'Staff'
            }
          ];
        }
          ...
          children: [
            isMobile
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                        const Text("STRUKTUR ORGANISASI PERUSAHAAN",
                            style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.w900,
                                color: AppColors.slate500,
                        ...
                        ElevatedButton.icon(
                          style: ElevatedButton.styleFrom(
                              ...
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(16))),
                          onPressed: () =>
                              _showStrukturDialog(null, null, strukturList),
                          icon: const Icon(Icons.add,
                              size: 16, color: Colors.white),
                          label: const Text("Departemen Baru",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 10,
                ...
                : Row(
                    ...
                    children: [
                      const Expanded(
                          child: Text("STRUKTUR ORGANISASI PERUSAHAAN",
                              style: TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w900,
                                  color: AppColors.slate500,
            ...
            if (sortedEntries.isEmpty)
              const Center(
                  child: Padding(
                      ...
                      child: Text("Belum ada data struktur organisasi",
                          style: TextStyle(
                              color: AppColors.slate400,
                              fontWeight: FontWeight.bold)))),
            ...sortedEntries.map((entry) {
              ...
              jabs.sort((a, b) => a['jabatan']
                  .toString()
                  .toLowerCase()
                  .compareTo(b['jabatan'].toString().toLowerCase()));
                    ...
                    children: [
                                      ...
                                      Row(
                                        children: [
                                          IconButton(
                                              ...
                                              onPressed: () =>
                                                  _showEditDepartemenDialog(
                                                      depName, strukturList)),
                                          const SizedBox(width: 16),
                                          IconButton(
                                              icon: const Icon(Icons.delete,
                                                  size: 16,
                                              ...
                                              onPressed: () async {
                                                bool confirm = await showDialog(
                                                    ...
                                                    builder: (c) => AlertDialog(
                                                          title: const Text(
                                                              "Hapus Departemen?"),
                                                          content: Text(
                                                              "Yakin ingin menghapus departemen '$depName' beserta seluruh jabatan di dalamnya?"),
                                                          actions: [
                                                            TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
                                                ...
                                                if (confirm == true) {
                                                  List<Map<String, dynamic>>
                                                      updated =
                                                      List.from(strukturList);
                                                  updated.removeWhere((item) =>
                                                      item['departemen'] ==
                                                      depName);
                                                  await _saveStrukturOrganisasi(
                                                      updated);
                                                }
                                              }),
                                        ],
                      ...
                      if (jabs.isEmpty)
                        const Padding(
                          ...
                          child: Text("Belum ada jabatan di departemen ini",
                              style: TextStyle(
                                  color: AppColors.slate400,
                                  fontStyle: FontStyle.italic)),
                        )
                                                              ...
                                                              (c) =>
                                                                  AlertDialog(
                                                                    title: const Text(
                                                                        "Hapus Jabatan?"),
                                                                    content: Text(
                                                                        "Yakin ingin menghapus posisi '$jabName' dari departemen '$depName'?"),
                                                                    actions: [
                                                                      TextButton(
  ...
  void _showStrukturDialog(int? indexToEdit, Map<String, dynamic>? itemToEdit,
      List<Map<String, dynamic>> currentList,
      {bool lockDepartemen = false}) {
            ...
            return AlertDialog(
              ...
              title: Row(
                children: [
                  ...
                  const SizedBox(width: 16),
                  Expanded(
                      child: Text(isEdit ? "EDIT POSISI" : "TAMBAH POSISI BARU",
                          style: TextStyle(
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("NAMA DEPARTEMEN / DIVISI",
                        style: TextStyle(
                            fontSize: 10,
                            fontWeight: FontWeight.w900,
                            color: AppColors.slate400,
                    ...
                    TextField(
                      ...
                      controller: TextEditingController(text: departemen)
                        ..selection =
                            TextSelection.collapsed(offset: departemen.length),
                      ...
                      style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: lockDepartemen
                              ? AppColors.slate500
                              : AppColors.slate800),
                      decoration: InputDecoration(
                          hintText: "Contoh: IT, Umum, Finance...",
                          filled: true,
                          fillColor: lockDepartemen
                              ? AppColors.slate100
                              : AppColors.slate50,
                          contentPadding: const EdgeInsets.symmetric(
                    ...
                    TextField(
                      ...
                      controller: TextEditingController(text: jabatan)
                        ..selection =
                            TextSelection.collapsed(offset: jabatan.length),
                      style: const TextStyle(
  ...
  void _showEditDepartemenDialog(
      String oldDepName, List<Map<String, dynamic>> currentList) {
        ...
        return StatefulBuilder(
          builder: (dialogContext, setDialogState) {
            ...
            void submitEdit() async {
              if (newDepName.trim().isEmpty || newDepName.trim() == oldDepName)
                return;
            ...
            return AlertDialog(
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("NAMA DEPARTEMEN / DIVISI BARU",
                        style: TextStyle(
                            fontSize: 10,
                            fontWeight: FontWeight.w900,
                            color: AppColors.slate400,
                    ...
                    TextField(
                      ...
                      controller: TextEditingController(text: newDepName)
                        ..selection =
                            TextSelection.collapsed(offset: newDepName.length),
                      style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: AppColors.slate800),
  ...
  Future<bool> _saveStrukturOrganisasi(
      List<Map<String, dynamic>> strukturList) async {
    Set<String> deps = {};
    Set<String> jabs = {};

    for (var item in strukturList) {
      if (item['departemen'].toString().isNotEmpty)
        deps.add(item['departemen']);
      if (item['jabatan'].toString().isNotEmpty) jabs.add(item['jabatan']);
    }

    var currentData =
        Map<String, dynamic>.from(await ApiService.getConfig('site') ?? {});
    ...
    if (success && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text("Berhasil menyimpan struktur organisasi!"),
          backgroundColor: AppColors.emerald500));
      setState(() => _configRefreshKey++);
    } else if (!success && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text("Gagal menyimpan struktur."),
          backgroundColor: AppColors.rose500));
    }
      ...
      children: [
        IconButton(
          icon: Icon(Icons.arrow_back,
              color: AppColors.slate500, size: isMobile ? 20 : 28),
          onPressed: () => setState(() => _activeSetting = 'menu'),
...
class _ProfileFormState extends State<_ProfileForm> {
  ...
  final TextEditingController _emailCtrl =
      TextEditingController(); // TAMBAHAN EMAIL
  final TextEditingController _alamatCtrl = TextEditingController();
  final TextEditingController _nikCtrl =
      TextEditingController(); // NRP Controller
  ...
  void _initData() {
    ...
    if (widget.configData.containsKey('struktur_organisasi')) {
      _strukturOrganisasi = List<Map<String, dynamic>>.from(
          widget.configData['struktur_organisasi']);
      Set<String> deps =
          _strukturOrganisasi.map((e) => e['departemen'].toString()).toSet();
      _departemens = deps.toList()
        ..sort((a, b) => a.toLowerCase().compareTo(b.toLowerCase()));
    } else {
      _departemens =
          List<String>.from(widget.configData['departemens'] ?? ['Umum'])
            ..sort((a, b) => a.toLowerCase().compareTo(b.toLowerCase()));
    }
    ...
    if (!['Laki-laki', 'Perempuan'].contains(_jenisKelamin))
      _jenisKelamin = 'Laki-laki';

    if (widget.userData['tanggal_lahir'] != null &&
        widget.userData['tanggal_lahir'].toString().isNotEmpty) {
      try {
    ...
    if (!_availableAreas.contains(_area))
      _area = _availableAreas.isNotEmpty ? _availableAreas.first : '';
  ...
  void _updateJabatanList(String departemen) {
    if (_strukturOrganisasi.isEmpty) {
      _jabatans = List<String>.from(widget.configData['jabatans'] ?? ['Staff'])
        ..sort((a, b) => a.toLowerCase().compareTo(b.toLowerCase()));
      return;
    }
    ...
    try {
      ...
      if (widget.userRole == 'Karyawan' && currentCount >= 3) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text(
                  "⛔ Foto profil sudah dikunci (batas 3x). Hubungi Admin untuk reset."),
              backgroundColor: AppColors.rose500));
        }
        return;
      }
      ...
      String? sourceChoice = await showDialog<String>(
          ...
          builder: (ctx) => AlertDialog(
                backgroundColor: Colors.white,
                title: const Text("Metode Pengambilan Foto",
                    style:
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      leading:
                          const Icon(Icons.image, color: AppColors.blue500),
                      title: const Text("Pilih File Foto dari Perangkat",
                          style: TextStyle(
                              fontSize: 13, fontWeight: FontWeight.bold)),
            ...
            builder: (c) => AlertDialog(
                  ...
                  content: const Row(
                    children: [
                      ...
                      SizedBox(width: 20),
                      Expanded(
                          child: Text("Mendaftarkan wajah ke Server AI...",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 13,
                                  color: AppColors.slate800))),
      ...
      var response =
          await ApiService.registerFaceBytes(imageBytes!, widget.userId);
      ...
      if (response['success'] == true) {
        setState(() {
          ...
          int currentCount = widget.userData['photo_change_count'] != null
              ? int.tryParse(
                      widget.userData['photo_change_count'].toString()) ??
                  0
              : 0;
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text(
                  "✅ Wajah berhasil dipindai dan didaftarkan ke sistem AI."),
              backgroundColor: AppColors.emerald500));
        }
      } else {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content:
                  Text("❌ Gagal mendaftarkan wajah: ${response['message']}"),
              backgroundColor: AppColors.rose500));
        }
      }
    } catch (e) {
  ...
  Future<void> _saveProfile() async {
    ...
    if (_photoBase64 == null || _photoBase64!.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text(
            "Akses Ditolak: Foto Profil wajib diunggah! Wajah Anda diperlukan untuk validasi Face Recognition saat absensi."),
        backgroundColor: AppColors.rose500,
  ...
  Widget build(BuildContext context) {
    ...
    int changeCount = widget.userData['photo_change_count'] != null
        ? int.tryParse(widget.userData['photo_change_count'].toString()) ?? 0
        : 0;
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(
            children: [
              IconButton(
                icon: Icon(Icons.arrow_back,
                    color: AppColors.slate500, size: isMobile ? 20 : 24),
              ...
              if (!_isEditMode)
                ...
                TextButton.icon(
                  style:
                      TextButton.styleFrom(foregroundColor: AppColors.slate500),
                  onPressed: () {
                    setState(() {
                      _isEditMode = false;
            ...
            Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(
                        child: Text(
                            "Profil Anda belum lengkap! Harap lengkapi semua data diri termasuk Alamat Email dan Foto Profil (Wajah).",
                            style: TextStyle(
                                color: AppColors.rose600,
                                fontWeight: FontWeight.bold,
                                fontSize: 11))),
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                        child: Text(
                            isPhotoLocked
                                ? "INFO: Foto Profil (Wajah), Departemen, dan Jabatan telah dikunci oleh sistem. Hubungi HR / Admin jika Anda ingin mereset perubahan."
                                : "INFO: Departemen dan Jabatan telah ditetapkan oleh sistem. Hubungi HR / Admin jika Anda memiliki kendala data.",
                            style: const TextStyle(
                                color: AppColors.blue500,
                                fontWeight: FontWeight.bold,
                                fontSize: 11))),
                ...
                Center(
                  child: Stack(
                    ...
                    children: [
                      ...
                      if (_isEditMode &&
                          !isPhotoLocked) // TOMBOL KAMERA HILANG JIKA SUDAH DIKUNCI
                        InkWell(
                          onTap: _pickImage,
                          child: Container(
                    ...
                    ? Column(children: [
                        ...
                        _buildInputCol(
                            ...
                            TextField(
                                ...
                                textInputAction: TextInputAction.next,
                                style: _textStyle(),
                                decoration: _inputDeco("No. HP Aktif"))),
                      ])
                    : Row(
                        children: [
                          Expanded(
                    ...
                    ? Column(children: [
                        _buildInputCol(
                            ...
                            TextField(
                                ...
                                textInputAction: TextInputAction.next,
                                style: _textStyle(),
                                decoration: _inputDeco("email@karyawan.com"))),
                        const SizedBox(height: 16),
                        _buildInputCol(
                            "ALAMAT LENGKAP",
                            TextField(
                                ...
                                style: _textStyle(),
                                decoration:
                                    _inputDeco("Alamat Lengkap Karyawan"))),
                      ])
                    : Row(
                        children: [
                          Expanded(
                    ...
                    ? Column(children: [
                            ...
                            isKaryawan
                                ? TextField(
                                    controller: TextEditingController(
                                        text: _departemen),
                                    enabled: false,
                                    style: _textStyle(isLocked: true),
                                    decoration: _inputDeco("", isLocked: true))
                                : DropdownButtonFormField<String>(
                                    isExpanded: true,
                                    initialValue: _departemen,
                                    icon: const Icon(Icons.keyboard_arrow_down,
                                        color: AppColors.slate500),
                                    decoration:
                                        _inputDeco("", isLocked: isKaryawan),
                                    items: _departemens
                                        .map((e) => DropdownMenuItem(
                                            value: e,
                                            child: Text(e,
                                                ...
                                                overflow:
                                                    TextOverflow.ellipsis)))
                                        .toList(),
                                    onChanged: (_isEditMode && !isKaryawan)
                                        ? (v) {
                                            setState(() {
                                              _departemen = v!;
                        ...
                        _buildInputCol(
                            ...
                            isKaryawan
                                ? TextField(
                                    controller:
                                        TextEditingController(text: _jabatan),
                                    enabled: false,
                                    style: _textStyle(isLocked: true),
                                    decoration: _inputDeco("", isLocked: true))
                                : DropdownButtonFormField<String>(
                ...
                isMobile
                    ? _buildInputCol(
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          icon: const Icon(Icons.keyboard_arrow_down,
                              color: AppColors.slate500),
                          decoration: _inputDeco("", isLocked: isKaryawan),
                          items: _availableAreas
                              .map((e) => DropdownMenuItem(
                                  value: e,
                                  child: Text(e,
                                      style: _textStyle(isLocked: isKaryawan),
                                      overflow: TextOverflow.ellipsis)))
                              .toList(),
                          onChanged: (_isEditMode && !isKaryawan)
                              ? (v) => setState(() => _area = v!)
  ...
  InputDecoration _inputDeco(String hint, {bool isLocked = false}) {
    return InputDecoration(
      ...
      filled: true,
      fillColor:
          (_isEditMode && !isLocked) ? AppColors.slate50 : AppColors.slate100,
...
class _WebCamCaptureDialogState extends State<_WebCamCaptureDialog> {
  ...
  Future<void> _initWebcam() async {
    try {
      ...
      if (mounted)
        setState(() {
          _error = "Gagal mengakses webcam: $e";
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            child: const Row(children: [
              ...
              Expanded(
                  child: Text(
                      "Arahkan wajah Anda ke kamera secara jelas.\nFoto ini akan menjadi data profil dan acuan verifikasi AI.",
                      style: TextStyle(
                          color: AppColors.blue500,
                          fontSize: 10,
                          fontWeight: FontWeight.bold,
          ...
          Expanded(
            child: Container(
              ...
              child: _isInitializing
                  ? const Center(
                      child:
                          CircularProgressIndicator(color: AppColors.yellow500))
                  : _error.isNotEmpty
                      ? Center(
                          child: Padding(
                              padding: const EdgeInsets.all(24),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Expanded(
              ...
              onPressed: (_isInitializing || _error.isNotEmpty || _isCapturing)
                  ? null
                  : () async {
                      ...
                      try {
                        ...
                        setState(() {
                          _error = "Gagal menangkap gambar: $e";
                          _isCapturing = false;
                        });
                      }
                    },
              ...
              label: Text(_isCapturing ? "MEMPROSES..." : "AMBIL FOTO WAJAH",
                  style: const TextStyle(
